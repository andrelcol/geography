        ...
        case "pt-BR":
            {
                ...
                var controls = new function () {
                    ...
                    this.choosePoligon = function () {
                        ...
                        if (this.wireframe) {
                            switch (this.tipo) {
                                case 'Tetraedro':
                                    this.tipo = 'TetrahedronWireframe';
                                    this.meshNumber = 5;
                                    break;
                                case 'Cubo':
                                    this.tipo = 'CubeWireframe';
                                    this.meshNumber = 6;
                                    break;
                                case 'Octaedro':
                                    this.tipo = 'OctahedronWireframe';
                                    this.meshNumber = 7;
                                    break;
                                case 'Dodecaedro':
                                    this.tipo = 'DodecahedronWireframe';
                                    this.meshNumber = 8;
                                    break;
                                case 'Icosaedro':
                                    this.tipo = 'IcosahedronWireframe';
                                    this.meshNumber = 9;
                                    break;
                            }
                        } else {
                    ...
                    this.resizePoligon = function () {
                        ...
                        poligon.scale.set(this.tamanho, this.tamanho, this.tamanho);
                        // console.log(poligon)
                        if (this.tamanho < 1.4 && this.tamanho >= 1) {
                            poligon.position.y = this.tamanho * 3 + 1.8;
                        }
                        if (this.tamanho >= 0.5 && this.tamanho < 1) {
                            poligon.position.y = this.tamanho * 3 + 1;
                        }
                        if (this.tamanho >= 1.4 && this.tamanho <= 2) {
                            poligon.position.y = this.tamanho * 3 + 2.5;
                        }
                    }
                    ...
                    this.updateColor = function () {
                        ...
                        objectArray = new Array();
                        objectMaterial = new THREE.MeshPhongMaterial({ color: controls.cor }); // Setting the material with new color
                        wireframe = new THREE.LineBasicMaterial({ color: controls.cor });
                    ...
                    this.wireframeController = function () {
                        ...
                        if (this.wireframe) {
                            ...
                            objectArray[this.meshNumber].visible = true;
                            objectArray[this.meshNumber].scale.set(this.tamanho, this.tamanho, this.tamanho);
                            this.wireframeStatus = true;
                        } else {
                            objectArray[this.meshNumber].visible = false;
                            if (this.meshNumber > 4) {
                ...
                //gui.add(controls, 'radius', 0, 40).step(1).onChange(controls.redraw);
                //gui.add(controls, 'detail', 0, 3).step(1).onChange(controls.redraw);
                guiFolder.addColor(controls, 'cor').onChange(function (e) {
                    controls.updateColor();
                });
                ...
                guiFolder.add(controls, 'tipo', ['Tetraedro', 'Cubo', 'Octaedro', 'Dodecaedro', 'Icosaedro']).onChange(function (e) {
                    if (this.wireframeStatus) {
                        this.meshNumber -= 5;
                    }
                    controls.choosePoligon();
                ...
                gui.add(controls, 'tamanho', 0.5, 2).listen().onChange(function (e) {
                    controls.resizePoligon()
                })
                controls.wireframeController();
                controls.choosePoligon(); // Update de selection of the polygon
